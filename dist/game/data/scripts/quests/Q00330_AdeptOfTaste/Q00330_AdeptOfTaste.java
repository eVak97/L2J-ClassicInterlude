					...
					case JONAS:
					{
						if (hasQuestItems(player, INGREDIENT_LIST))
						{
							...
							else
							{
								...
								final int specialIngredientsNumber = (int) (getQuestItemsCount(player, WHITE_MANDRAGORA_SAP) + getQuestItemsCount(player, GOLDEN_HONEY) + getQuestItemsCount(player, BROWN_MOSS_BUNDLE));
								if (getRandomBoolean())
								{
