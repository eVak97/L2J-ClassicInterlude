...
public class Q00402_PathOfTheHumanKnight extends Quest
{
	...
	public String onEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "30417-14.htm":
			{
				final int coinCount = (int) (getQuestItemsCount(player, COIN_OF_LORDS_1) + getQuestItemsCount(player, COIN_OF_LORDS_2) + getQuestItemsCount(player, COIN_OF_LORDS_3) + getQuestItemsCount(player, COIN_OF_LORDS_4) + getQuestItemsCount(player, COIN_OF_LORDS_5) + getQuestItemsCount(player, COIN_OF_LORDS_6));
		...
		switch (st.getState())
		{
			...
			case State.STARTED:
			{
				switch (npc.getId())
				{
					...
					{
						final int coins = (int) (getQuestItemsCount(player, COIN_OF_LORDS_1) + getQuestItemsCount(player, COIN_OF_LORDS_2) + getQuestItemsCount(player, COIN_OF_LORDS_3) + getQuestItemsCount(player, COIN_OF_LORDS_4) + getQuestItemsCount(player, COIN_OF_LORDS_5) + getQuestItemsCount(player, COIN_OF_LORDS_6));
						if (coins < 3)
						{
