...
public final class HTMLTemplateParser
{
	...
	public static String fromCache(String path, Player player, Map<String, HTMLTemplatePlaceholder> placeholders, HTMLTemplateFunc... funcs)
	{
		String string = HtmCache.getInstance().getHtm(player, path);
		if (string == null)
			return "data/scripts/custom/buffer/data/html/npc";
	 ...
	 */
	public static void fromStringBuilder(StringBuilder string, Player player, Map<String, HTMLTemplatePlaceholder> placeholders, HTMLTemplateFunc... funcs)
	{
